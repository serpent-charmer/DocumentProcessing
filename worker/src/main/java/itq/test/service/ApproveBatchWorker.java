...
@Component
public class ApproveBatchWorker {
    @Autowired
    ...
    private final Logger log = LoggerFactory.getLogger(ApproveBatchWorker.class);
    private int count = 0;
    public static final DocumentStatus DOCUMENT_STATUS = DocumentStatus.DRAFT;
    ...
    private void processPage(Slice<Document> page) {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("http://127.0.0.1:8080/api/v1/document/submit"))
